...
dialog --begin 10 10 --backtitle "Información y Resultados" \
...
sleep 1s;
xterm -xrm 'XTerm.vt100.allowTitleOps: false'  -fa 'Monospace' -fs 14  -T terminal_curseofwar -e "curseofwar -W 30 -H 30" &
sleep 2s;
